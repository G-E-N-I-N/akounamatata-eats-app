  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-champagne via-background to-champagne overflow-hidden">
      ...
      <section className="py-16 px-4 bg-gradient-to-r from-slate-blue to-slate-blue/90 relative overflow-hidden">
        <div className="absolute inset-0 bg-[url('data:image/svg+xml;utf8,<svg width=\"60\" height=\"60\" viewBox=\"0 0 60 60\" xmlns=\"http://www.w3.org/2000/svg\"><g fill=\"none\" fill-rule=\"evenodd\"><g fill=\"%23ffffff\" fill-opacity=\"0.05\"><circle cx=\"30\" cy=\"30\" r=\"2\"/></g></g></svg>')] opacity-30"></div>
        <div className="container mx-auto text-center relative z-10">
